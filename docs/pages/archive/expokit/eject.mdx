...
> **warning** ExpoKit is deprecated and is no longer supported after SDK 38. If you need to make customizations to your Expo project, we recommend using the [bare workflow](/introduction/managed-vs-bare/#bare-workflow) instead.
